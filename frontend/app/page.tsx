...
export default function WoxsenCampusPortalPage() {
  ...
  // =======================================================================
  // VIEW 1: UNAUTHENTICATED VIEW (EMAIL LOGIN & SIGN UP WALL)
  // =======================================================================
  if (!isAuthenticated) {
    return (
      <div className="py-6 sm:py-12 px-3.5 sm:px-6 max-w-3xl mx-auto space-y-8 animate-in fade-in duration-300">
        {/* Woxsen Brand Banner */}
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl space-y-6">
          ...
          {/* TAB 2: SIGN UP (LOGS IN AS STUDENT FIRST; ADMIN CAN CHANGE TO STAFF/WORKER) */}
          {authTab === 'signup' && (
